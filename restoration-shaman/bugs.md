---
sidebar_position: 8
description: Current known bugs for Restoration Shaman
title: Known Bugs
---

This is a list of all currently known bugs affecting Restoration Shaman. If you find any bug or inconsistent behavior not listed here please let us known by contacting Harrek on the [Ancestral Guidance Discord](https://discord.gg/AcTek6e) or the [SpiritbloomPro Discord](http://discord.spiritbloom.pro).
...
| !Downpour! | !Downpour! has weird interactions with the Cooldown Manager. As Farseer the !Healing Rain! tracker won't show up while you still have !Downpour! available, and as Totemic !Downpour! makes the !Surging Totem! tracker not work at all |
| !Flame Shock!, !Lava Surge! | The proc rate of !Lava Surge! does not increase by having !Flame Shock! active on more targets |
