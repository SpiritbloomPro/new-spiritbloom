...
The most meaningful decision concerning talents is the choice node of !Dream Simulacrum! and !Wings of Liberty!, due to their unique gameplay elements. Despite having different strengths, my recommendation is by far !Dream Simulacrum!. The ability to cast !Verdant Embrace! without thinking about your positioning is well worth any throughput differences.
...
The largest upgrade you can have is your weapon, if you do not have a myth track weapon it should be the first piece of gear you look to obtain. Crafting is a great way to do this as it is reasonable to obtain early on in the season. If you decide to craft a weapon it can be made with [Darkmoon Sigil: Hunt](https://www.wowhead.com/item=245876/) and pair it in the slot of your choice with [Arcanoweave Lining](https://www.wowhead.com/item=240167/) as your second embellishment.

If you wish to play the long game, and aren't interested in immediate upgrades, then instead of crafting the [Arcanoweave Lining](https://www.wowhead.com/item=240167/) craft the [Root Warden's Regalia](https://www.wowhead.com/item-set=1967/) set instead, choosing the [World Tenders Barkclasp](https://www.wowhead.com/item=244611/) and [World Tender's Rootslippers](https://www.wowhead.com/item=244610/), as they are your true endgame BIS embellishments.

### Trinkets and Special Items

Trinkets provide powerful effects and there a few notably strong options:

1. [Gaze of the Alnseer](https://www.wowhead.com/item=249343/) is a strong stat stick that gives us the most boost to the healing of all the choices.
2. [Litany of Lightblind Wrath](https://www.wowhead.com/item=249808/) is an on use trinket that allows us to provide a small shield effect on our team.
3. [Emerald Coach's Whistle](https://www.wowhead.com/item=193718) is a stat stick that is easily grindable that also has a support aspect to it.
4. [Heart of Wind](https://www.wowhead.com/item=250256/) another easily grindable stat stick that  will be a very good early pick up.
5. [Refueling Orb](https://www.wowhead.com/item=250246/) is a lack luster trinket but does allow for our DPS to do a tiny bit more damage.
